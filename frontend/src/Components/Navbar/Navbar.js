...
//     { name: 'Faculty', to: '/faculty', current: false },
...
const navigation = [
  ...
  //   const datils = async () => {
  //     try {
  //         const response = await axios.get(`http://localhost:5050/studentDetails/?email=${email}`);
  //         console.log("Response Data:", response.data); // Log the entire response data
  //         const studentDetails = response.data;
  //         const imageUrl = studentDetails.img;
  //         return imageUrl;
  //     } catch (error) {
...
//     const images = () => {
//       // Check if Records is an array before mapping over it
